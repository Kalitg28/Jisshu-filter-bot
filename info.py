...
USERNAME = environ.get('USERNAME', "https://t.me/Indian_MV_Admin_Bot") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002008970692'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Movies_Request_MV')
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002500921176'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1001964046412')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002682670262'))
auth_channel = environ.get('AUTH_CHANNEL', '')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', 'https://t.me/Indian_MV_Group'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002555072517') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002287992101')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Indian_MV_Group') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
IS_VERIFY = is_enabled('IS_VERIFY', False)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/How_To_Download_MVS/4")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/How_To_Download_MVS/4")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/How_To_Download_MVS/4")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "9a0544addc47c0757f288817afe08c785c0e80d1")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'Shortxlinks.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "9a0544addc47c0757f288817afe08c785c0e80d1")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'Shortxlinks.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "9a0544addc47c0757f288817afe08c785c0e80d1")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://envs.sh/6UJ.jpg https://envs.sh/6UJ.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://envs.sh/6U4.jpg')).split()
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/4J6.jpg'))
REACTIONS = ["❤️", "😘", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
#---------------------------------------------------------------
#---------------------------------------------------------------
#---------------------------------------------------------------
